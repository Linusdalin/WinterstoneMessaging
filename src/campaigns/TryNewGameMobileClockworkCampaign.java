...
public class TryNewGameMobileClockworkCampaign extends AbstractCampaign implements CampaignInterface {
    ...
    public static EmailInterface gameActivationEmail(User user, Reward reward, String promoCode) {
        ...
        return new NotificationEmail("We have a recommendation for you",
                ...
                "<p>Don't miss out one of the most liked games at SlotAmerica. It is called <b>"+ GameName+"</b>. with a very cool freespin functionality" +
                ".</p<" +
