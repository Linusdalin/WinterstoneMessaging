...
public class GiveCoinAction extends Action implements ActionInterface{
    ...
    public GiveCoinAction(int id, long amount, ActionParameter parameter, Timestamp timeStamp, int significance, String campaignName, int messageId, CampaignState state, double responseFactor){
